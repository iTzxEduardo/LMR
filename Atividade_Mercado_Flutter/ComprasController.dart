import 'package:atividade_somativa/ComprasModel.dart';
...
// Método para adicionar uma nova compra à lista
  ...
  void adicionarCompra(String descricao, Color corVerde) {
  if (descricao.trim() != '') { 
    ...
    // Se a compra já existe, exibe uma mensagem e retorna sem adicionar
    if (jaExiste) {
      // Exibe uma mensagem indicando que a tarefa já existe
      throw Exception('Item já adicionado a sua lista de compra');
    }
